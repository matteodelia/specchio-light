...
function displaySquare() {
  if (via>0) {
    ...
    // stroke("red");
    // ellipse(corner.x,corner.y,10)
    // ellipse(corner.x,corner.y + cornerH.y,10)
    // ellipse(corner.x - cornerW.x,corner.y +cornerH.y,10)
    // ellipse(corner.x - cornerW.x,corner.y,10)
    //
    // beginShape()
    //
    // var a = random(0,50)
    // vertex(corner.x,corner.y)
    // bezierVertex(corner.x + a,corner.y + a,corner.x + a,corner.y + a,corner.x,corner.y)
    // bezierVertex(corner.x + a,corner.y + cornerH.y + a,corner.x + a,corner.y + cornerH.y + a,corner.x,corner.y + cornerH.y)
    // bezierVertex(corner.x - cornerW.x + a,corner.y + cornerH.y + a,corner.x - cornerW.x + a,corner.y + cornerH.y + a,corner.x - cornerW.x,corner.y + cornerH.y)
    // bezierVertex(corner.x - cornerW.x + a,corner.y + a,corner.x - cornerW.x + a,corner.y + a,corner.x - cornerW.x,corner.y)
    // bezierVertex(corner.x + a,corner.y + a,corner.x + a,corner.y + a,corner.x,corner.y)

    // curveVertex(corner.x,corner.y);
    // curveVertex(corner.x,corner.y);
    // curveVertex(corner.x,corner.y + cornerH.y);
    // curveVertex(corner.x - cornerW.x,corner.y +cornerH.y);
    // curveVertex(corner.x - cornerW.x,corner.y);
    // curveVertex(corner.x,corner.y);
    // curveVertex(corner.x,corner.y);
